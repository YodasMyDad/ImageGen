...
# Build ImageGenApp for x86 (32-bit) architecture as framework-dependent deployment
# This requires .NET 9 Desktop Runtime to be installed on target machines but is much more reliable

Write-Host "Building ImageGenApp for x86 (framework-dependent)..." -ForegroundColor Green
