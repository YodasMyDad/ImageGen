...
# Build ImageGenApp for x64 architecture as framework-dependent deployment
# This requires .NET 9 Desktop Runtime to be installed on target machines but is much more reliable

Write-Host "Building ImageGenApp for x64 (framework-dependent)..." -ForegroundColor Green
